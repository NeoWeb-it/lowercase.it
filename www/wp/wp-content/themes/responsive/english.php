...
<!--NEWS - query1-->
    	<div class="sezioni-site" id="sezione-news">
  			...
  			<?php // include ('wp/wp-includes/en-news.php')?> 
        	<div class="su">
            	<a href="#menu">
 ...
 <div ><a title="projects" name="projects" style="position: absolute; top:-18% height: 10px; width: 10px;margin-top: -105px;" ></a></div>      
...
<!--EDIZIONI - query2-->
    	<div class="sezioni-site" id="sezione-edizioni">
 			<?php //include ('wp/wp-includes/en-edizioni.php')?> 
        	<div class="su"><a href="#menu"><img src="http://lowercase.it/wp/img/su.png" border="0"></a></div>
<div ><a title="who" name="who"  style="position: absolute; top:-18% height: 10px; width: 10px; margin-top: -105px;" ></a></div>          
       </div>
...
<!--CHI-->
    	 <div class="sezioni-site" id="sezione-chi">
            <?php //include ('wp/wp-includes/EN-chi.php'); ?>
         	<div class="su"><a href="#menu"><img src="http://lowercase.it/wp/img/su.png" border="0"></a></div>
 <div ><a title="pep" name="pep"  style="position: absolute; top:-18% height: 10px; width: 10px; margin-top: -105px;" ></a></div>            
         </div>

<!--C&S-->
    	 <div class="sezioni-site" id="sezione-ces">
            <?php //include ('wp/wp-includes/en-ces.php'); ?>
         	<div class="su"><a href="#menu"><img src="http://lowercase.it/wp/img/su.png" border="0"></a></div>
 <div ><a title="where" name="where"  style="position: absolute; top:-18% height: 10px; width: 10px; margin-top: -105px;" ></a></div>
         </div>

<div class="sezioni-site" id="sezione-dove">
            <?php //include ('wp/wp-includes/en-dove.php'); ?>
         	<div class="su"><a href="#menu"><img src="http://lowercase.it/wp/img/su.png" border="0"></a></div>
 <div ><a title="contacts" name="contacts"  style="position: absolute; top:-18% height: 10px; width: 10px; margin-top: -105px;" ></a></div>
         </div>
...
<!--CONTATTI-->
    	 <div class="sezioni-site" id="sezione-contatti">
			 <?php //include ('wp/wp-includes/en-contatti.php'); ?>
         	<div class="su"><a href="#menu"><img src="http://lowercase.it/wp/img/su.png" border="0"></a></div>
