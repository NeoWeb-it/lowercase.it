...
function the_content( $more_link_text = null, $strip_teaser = false) {
	...
	$content = str_replace( '<a href="http://www.lowercase.it/wp/wp-content/uploads/2013/08/carrello.jpg"><img src="http://www.lowercase.it/wp/wp-content/uploads/2013/08/carrello-282x300.jpg" alt="carrello" width="282" height="300" class="alignnone size-medium wp-image-410" />', '<a href="mailto:shop@lowercase.it"><img src="http://www.lowercase.it/wp/wp-content/uploads/2013/08/carrello-282x300.jpg" alt="carrello" width="282" height="300" class="alignnone size-medium wp-image-410" id="carrello"/>', $content );
	$content = str_replace( 'alt="video"', 'alt="video" id="video"', $content );
	echo $content;
}
